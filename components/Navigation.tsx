        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              aria-label="WhatsApp"
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="flex-shrink-0" style={{ overflow: 'visible' }}>
            ...
            {/* Cotizar — solo desktop */}
            <button
              onClick={handleCTAClick}
              className="hidden sm:block gradient-bg text-white text-sm font-semibold px-5 py-2.5 rounded-lg hover:opacity-90 transition-all duration-200 hover:shadow-glow-purple"
            >
              Cotizar ahora
            </button>
          </div>
