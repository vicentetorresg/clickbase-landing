...
export default function StickyMobileCTA() {
  ...
  return (
    ...
    >
      ...
      {/* Buttons */}
      <div className="relative flex flex-col gap-2 p-4 pb-safe">
        <a
          ...
          className="w-full flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-bold py-4 rounded-xl text-base transition-all duration-200"
        ...
        >
          ...
          Cotizar por WhatsApp — gratis y sin compromiso
        </a>
        <button
