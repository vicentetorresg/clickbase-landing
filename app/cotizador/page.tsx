    ...
    <div className="min-h-screen bg-dark text-white">
      ...
      <div className="border-b border-white/5 px-6 py-4 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/cotizador/onboardings"
            className="flex items-center gap-1.5 text-xs font-medium text-brand-purple-light border border-brand-purple/30 hover:border-brand-purple hover:bg-brand-purple/10 px-3 py-1.5 rounded-lg transition-all duration-200"
          >
