      ...
      <main>
        ...
        <section className="py-12 relative overflow-hidden">
          <div
            ...
            style={{ background: 'linear-gradient(135deg, rgba(37,211,102,0.06) 0%, rgba(124,58,237,0.08) 100%)' }}
          />
          <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <p className="text-sm font-semibold text-[#25D366] uppercase tracking-widest mb-3">Respuesta rápida</p>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-white mb-3">
              ¿Tienes dudas? Escríbenos y te orientamos.
            </h2>
            <p className="text-slate-400 mb-7 max-w-xl mx-auto">
              Cuéntanos de tu negocio por WhatsApp y revisamos juntos si el pack te sirve.
              Sin compromiso, sin formularios.
            </p>
            <a
              href="https://wa.me/56994366697?text=Hola%2C%20quiero%20cotizar%20la%20p%C3%A1gina%20web%20%2B%20campa%C3%B1a%20%2B%20tracking.%20%C2%BFMe%20pueden%20dar%20m%C3%A1s%20informaci%C3%B3n%3F"
              target="_blank"
