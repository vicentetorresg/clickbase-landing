...
export default function RootLayout({
  ...
  return (
    <html lang="es" className={inter.variable}>
      <head>
        <meta name="facebook-domain-verification" content="4rqpkgter4v971ii20cufuiwrlhvin" />
        <meta name="facebook-domain-verification" content="xj2vetuksry1hcj2w5ovoq6u4kyvyl" />
        {/* Google Tag Manager */}
